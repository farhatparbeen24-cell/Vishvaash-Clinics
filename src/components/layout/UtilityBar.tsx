...
export function UtilityBar() {
  const { t } = useLanguage();
  return (
    <div className="bg-navy-deep text-aqua/90">
      <div className="mx-auto flex h-10 max-w-6xl items-center justify-between gap-3 px-4 sm:px-6">
        <p className="hidden items-center gap-2 text-xs tracking-wide text-aqua/70 md:inline-flex">
        ...
        <div className="flex w-full items-center justify-between gap-1 md:w-auto md:justify-end md:gap-6">
          ...
          <span aria-hidden className="h-3 w-px bg-aqua/25 md:hidden" />
          <a
          ...
          <span aria-hidden className="h-3 w-px bg-aqua/25" />
          <a
